...
> **⚠️ Templar is dormant**
>
> The Covenant-72B training run is complete - the largest model trained on decentralized infrastructure (72B parameters). Templar's decentralized training protocol is not currently active, but may return in the future.
>
> Subnet 3 is now running **Crusades**, an MFU optimization competition on the same subnet (netuid 3) but with a different mechanism. See [one-covenant/crusades](https://github.com/one-covenant/crusades) for details.
